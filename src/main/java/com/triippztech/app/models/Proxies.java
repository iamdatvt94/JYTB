...
public class Proxies {
    ...
    public void generateProxies() {
        ...
        try {
            ...
            // khong goi tu mang ve nua, set tay thoi
            String json = "{\"data\":[{\"ipPort\":\"85.10.219.99:1080\",\"ip\":\"85.10.219.99\",\"port\":\"1080\",\"country\":\"DE\",\"last_checked\":\"2020-07-23 14:09:58\",\"proxy_level\":\"elite\",\"type\":\"socks4\",\"speed\":\"15\",\"support\":{\"https\":1,\"get\":1,\"post\":1,\"cookies\":1,\"referer\":1,\"user_agent\":1,\"google\":0}}],\"count\":1}";
            proxies = gson.fromJson(json, PubProxies.class);
